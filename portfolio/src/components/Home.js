    ...
    return (
        ...
        <div className="w-full h-screen bg-[#0a192fec] flex justify-center items-center flex-col">
            <div className='md:max-w-[800px] mx-4 '>
                ...
                <p className='text-lg md:text-xl text-gray-400'>My proficiency with frameworks React Some of my recent work includes creating a dynamic e-commerce platform using React and Redux building a responsive landing page with Bootstrap and Tailwind css</p>
            </div>
